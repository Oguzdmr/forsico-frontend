...
class List {
  async getList(token, workspaceId, listId) {
    ...
    try {
      const response = await fetch(
        `${config.boardApiBaseUrl}/list/${listId}`,
        requestOptions
      );
  ...
  async deleteList(token, workspaceId, listId) {
    ...
    try {
      const response = await fetch(
        `${config.boardApiBaseUrl}/list/${listId}?=${workspaceId}`,
        requestOptions
      );
      const result = await response.json();
      return result;
  ...
  async getListsOfBoard(token, workspaceId, boardId) {
    ...
    try {
      const response = await fetch(
        `${config.boardApiBaseUrl}/list/getlistsofboard/${boardId}`,
        requestOptions
      );
      const result = await response.json();
      return result;
